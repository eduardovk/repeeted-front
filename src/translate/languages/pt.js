    ...
    pt: {
        translations: {
            ...
            about: {
                author: 'Autor',
                what: 'O quê?',
                whatParagraph: '_ _ _ é um site que lhe permite descobrir quais as palavras mais repetidas por um artista ou banda, contando atualmente com mais de 20 mil artistas no seu banco de dados, nos idiomas português, inglês e espanhol.',
                why: 'Por quê?',
                whyParagraph: '_ _ _ é o produto de uma idéia surgida durante uma conversa despretensiosa, na qual eu discutia com um amigo qual seria o resultado se pudéssemos resumir uma banda através das palavras mais repetidas nas letras de suas músicas.',
            ...
            howItWorks: {
                paragraph1: '_ _ _ é um projeto motivado pelo aprendizado de novas tecnologias e pela diversão de programar soluções. Seu propósito é permitir descobrir quais as palavras mais repetidas por um artista ou banda, recorrendo para isto a tecnologias como web scrapping, REST, React, Node.js, entre outras.',
